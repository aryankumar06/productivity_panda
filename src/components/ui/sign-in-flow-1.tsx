...
function MiniNavbar() {
  ...
  const signupButtonElement = (
    <div className="relative group w-full sm:w-auto">
      ...
      <a
        href="/signup"
        className="relative z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 w-full sm:w-auto block text-center"
      >
        Sign Up
      </a>
    </div>
                ...
                {step === "email" ? (
                  ...
                  >
                      ...
                      <form onSubmit={handleEmailSubmit}>
                        <div className="relative">
                          <input
                            ...
                            className="w-full backdrop-blur-[1px] text-white border border-white/10 bg-transparent rounded-full py-3 px-4 focus:outline-none focus:border-white/30 text-center"
                            required
                          />
                          <button
                            type="submit"
                    ...
                    <p className="text-xs text-white/40 pt-10">
                      ...
                      <a href="/terms-of-service" className="underline text-white/40 hover:text-white/60 transition-colors">
                        Terms of Service
                      </a>
                      ,{" "}
                      <a href="/privacy-policy" className="underline text-white/40 hover:text-white/60 transition-colors">
                        Privacy Policy
                      </a>
                      , and{" "}
